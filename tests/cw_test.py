...
class TestE2E(unittest.TestCase):
    ...
    def test_rds_alarms_burst_balance_too_low_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_cloudwatch_metric_alarm.burst_balance_too_low"]["alarm_name"], "foo-burst-balance-too-low")
    ...
    def test_rds_alarms_cpu_utilization_too_high_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_cloudwatch_metric_alarm.cpu_utilization_too_high"]["alarm_name"], "foo-CPU-Utilization-too-high")
    ...
    def test_rds_alarms_disk_queue_depth_too_high_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_cloudwatch_metric_alarm.disk_queue_depth_too_high"]["alarm_name"], "foo-disk-queue-depth-too-high")
    ...
    def test_rds_alarms_freeable_memory_too_low_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_cloudwatch_metric_alarm.freeable_memory_too_low"]["alarm_name"], "foo-freeable-memory-too-low")
    ...
    def test_rds_alarms_free_storage_space_too_low_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_cloudwatch_metric_alarm.free_storage_space_too_low"]["alarm_name"], "foo-free-storage-space-too-low")
    ...
    def test_rds_alarms_swap_usage_too_high_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_cloudwatch_metric_alarm.swap_usage_too_high"]["alarm_name"], "foo-swap-usage-too-high")
    ...
    def test_lambda_slack_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_lambda_function.lambda_slack"]["tags.Name"], "lambda-slack-foo-notprod")

    def test_lambda_slack_function_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_lambda_function.lambda_slack"]["function_name"], "foo-lambda-slack-notprod")

    def test_lambda_iam_policy_name(self):
        self.assertEqual(self.result['rds_alarms']["aws_iam_role_policy.lambda_policy_slack"]["name"], "foo-lambda-policy-slack-notprod")
